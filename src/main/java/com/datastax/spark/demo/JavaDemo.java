...
public class JavaDemo implements Serializable {
                ...
                .flatMapToPair(new PairFlatMapFunction<Tuple2<Integer, Tuple2<Sale, Product>>, Integer, BigDecimal>() {
                    ...
                    public Iterable<Tuple2<Integer, BigDecimal>> call(
                        ...
                        allSales.add(new Tuple2<>(saleWithProduct._1()
                                .getProduct(), saleWithProduct._1().getPrice()));
    ...
    public static class Product implements Serializable {
         ...
         *
         */
        private static final long serialVersionUID = 709522157075972358L;
        private Integer id;
        private String name;
    ...
    public static class Sale implements Serializable {
         ...
         *
         */
        private static final long serialVersionUID = 2470714425488268280L;
        private UUID id;
    ...
    public static class Summary implements Serializable {
         ...
         *
         */
        private static final long serialVersionUID = 3224342348306260090L;
        private Integer product;
